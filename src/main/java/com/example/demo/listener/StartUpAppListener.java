...
public class StartUpAppListener {
    ...
    @Autowired CollaborateursRepository collaborateurs;
    @Autowired DepartementRepository departements;
    @Autowired BanqueRepository banques;
    ...
    public void contextRefreshedEvent() {
    	...
    	collaborateurs.save(new Collaborateurs("LMV", "LEMARIE", "Valentin",banques.getOne(1) ,departements.getOne(1)));
    	collaborateurs.save(new Collaborateurs("TG", "TOURRILHES", "Géraud",banques.getOne(2) ,departements.getOne(2)));
    	collaborateurs.save(new Collaborateurs("LMB", "LEMARIE", "Benjamin",banques.getOne(3) ,departements.getOne(3)));
    }
}